...
<table align="center" style="width:100%; border-collapse:separate; border-spacing:12px; background:rgba(255,255,255,.03); border:1px solid rgba(255,255,255,.08); border-radius:12px;">
  ...
  <td style="width:70%; padding:20px; vertical-align:middle;">
    <h3>Likith G S</h3>
    <p><em>AI Engineer • Full Stack Developer • GenAI Developer • Data Scientist</em></p>

  <p>
    Building impactful AI-driven solutions using <b>Django</b>, <b>React</b>, <b>MongoDB</b>, and <b>Streamlit</b>.<br/>
    Currently working on: <a href="https://harlee.pro/projects/bioprompt"><b>BioPrompt.AI</b></a>
  </p>
  ...
  <tr>
    <td colspan="2" style="padding:0; background:rgba(255,255,255,.02); border:1px solid rgba(255,255,255,.08); border-radius:8px;">
      <img
        ...
        alt="GitHub Activity Graph for Likith G S" width="100%">
    </td>
  </tr>
</table>
...
Built with dedication by Hari Haran • Open for collaborations
